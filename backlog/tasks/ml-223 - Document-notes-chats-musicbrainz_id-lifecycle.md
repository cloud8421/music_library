...
- [ ] #1 Notes and Chats context @moduledoc explain that rows are keyed by musicbrainz_id and intentionally survive record deletion and re-import
- [ ] #2 docs/architecture.md mentions the lifecycle in the relevant schema/context rows
- [ ] #3 No behaviour change; full test suite passes
<!-- AC:END -->
